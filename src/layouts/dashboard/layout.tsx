...
import { navData as dashboardNavData, filterNavDataByRoles } from '../config-nav-dashboard';
...
export function DashboardLayout({ sx, children, header, data }: DashboardLayoutProps) {
  ...
  const userRoles = getRolesFromToken(); // Obtén los roles del token
  const filteredNavData = filterNavDataByRoles(userRoles, dashboardNavData); // Filtra el navData basado en roles
